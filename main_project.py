...
director.init(width=1024, height=576, caption="Cyber Match!")
...
def calculate_score(score):
    current_time = score
    loaded_time = load_score("cyber/score.txt")
...
class CardLayer(cocos.layer.Layer):
    ...
    def __init__(self, image_path):
        ...
        self.back = cocos.sprite.Sprite('cyber/img/back.png',anchor=(0,0))
...
class CardManager():
    ...
    def __init__(self):
        ...
        self.current_level = self.level4 # تغيير عدد الكروت
...
class MainMenu(cocos.menu.Menu):
    def __init__(self):
        super().__init__('CYBER MATCH GAME')
...
class Button(cocos.layer.Layer):
    ...
    def __init__(self, pos):
        super().__init__()
        self.spr = cocos.sprite.Sprite('cyber/img/back_to_main.png')
...
class StartScene(cocos.scene.Scene):
    def __init__(self):
        ...
        menu = MainMenu()
        # self.add(cocos.layer.ColorLayer(50, 180, 180, 180))
        self.add(cocos.sprite.Sprite('cyber/img/background.jpeg',position=(500,215)))
...
class GameScene(cocos.scene.Scene):
    ...
    def __init__(self):
        ...
        self.add(cocos.layer.ColorLayer(0, 0, 0, 180))
...
class BestTimeScene(cocos.scene.Scene):
    ...
    def on_enter(self):
        super().on_enter()
        self.label.element.text = load_score("cyber/score.txt")
...
class WinningScene(cocos.scene.Scene):
    ...
    def on_enter(self):
        ...
        if calculate_score(Timer.current_time):
            save_score("cyber/score.txt", Timer.current_time)
